...
export class NodemailerContactUsEmailService implements ContactUsEmailService {
    public SendContact(contact: Contact): Promise<Result<void, EmailService.Error.ConnectionError>> {
        const template = /* html */`
        ...
        // return Promise.resolve(Result.Fail(new EmailService.Error.ConnectionError))
